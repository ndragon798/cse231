...
##
## turtle.color(s): The color is a string such as "green"
##
...
##
## turtle.circle(radius): draw a circle of the indicated radius. The
## turtle draws counterclockwise .
##
...
#x=input("Then press Enter to continue ...")
